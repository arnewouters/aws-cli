...
# the auth module imports functions/classes defined above from
...
AUTH_TYPE_MAPS = {
    ...
    's3v4a': auth.CrtS3SigV4AsymAuth,
    's3v4a-query': auth.CrtS3SigV4AsymQueryAuth,
