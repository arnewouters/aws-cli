...
from . import UNSIGNED, exceptions, parsers, serialize
from .config import Config
from .endpoint import EndpointCreator
from .regions import EndpointResolverBuiltins as EPRBuiltins
from .regions import EndpointRulesetResolver
...
class ClientArgsCreator:
    ...
    def _handle_checksum_config(
        ...
        if value not in valid_options:
            raise exceptions.InvalidChecksumConfigError(
